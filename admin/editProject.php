            ...
            <form method="POST" action="updateProject.php" class="p-6 space-y-6">
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Budget (KES) *</label>
                            <input type="number" name="total_budget" step="0.01" min="0" value="<?php echo $project['total_budget']; ?>" required 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
